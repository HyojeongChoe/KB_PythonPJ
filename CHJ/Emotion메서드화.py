...
class EMOTION:
    ...
    def indiJoy():
        ...
        return random.choice(indiJoySong)
    ...
    def indiSad():
        ...
        return random.choice(indiSadSong)
    ...
    def indiAnge():
        ...
        return random.choice(indiAngerSong)
    ...
    def indiUnrest():
        ...
        return random.choice(indiUnrestSong)
    ...
    def indiBoring():
        ...
        return random.choice(indiBoringSong)
    ...
    def hipJoy():
        ...
        return random.choice(hipJoySong)
    ...
    def hipSad():
        ...
        return random.choice(hipSadSong)
    ...
    def hipAnger():
        ...
        return random.choice(hipAngerSong)
    ...
    def hipUnrest():
        ...
        return random.choice(hipUnrestSong)
    ...
    def hipBoring():
        ...
        return random.choice(hipBoringSong)
    ...
    def idolJoy():
        ...
        return random.choice(idolJoySong)
    ...
    def idolSad():
        ...
        return random.choice(idolSadSong)
    ...
    def idolAnger():
        ...
        return random.choice(idolAngerSong)
    ...
    def idolUnrest():
        ...
        return random.choice(idolUnrestSong)
    ...
    def idolBoring():
        ...
        return random.choice(idolBoringSong)
    ...
    def balJoy():
        ...
        return random.choice(balJoySong)
    ...
    def balSad():
        ...
        return random.choice(balSadSong)
    ...
    def balAnger():
        ...
        return random.choice(balAngerSong)
    ...
    def balUnrest():
        balUnrestSong = [
            ...
            # 진심이 담긴 노래 - 케이시
            '케이시 https://youtu.be/nuUSmMZXgxI?si=ssJqDRl5Wrnaazc7',
            #한숨 - 이하이
            'https://youtu.be/AT9e7H-X4Pg?si=GWxq0mySmWqGdSly'
        ]
        return random.choice(balUnrestSong)
    ...
    def balBoring():
        ...
        return random.choice(balBoringSong)
